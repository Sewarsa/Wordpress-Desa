<?php
/**
 * WXR importer class used in the AF Companion plugin.
...
// Include files.
require AFTC_PATH . 'inc/importer/class-wxr-importer.php';

class AFTC_WXR_Importer extends HM_WXR_Importer {
