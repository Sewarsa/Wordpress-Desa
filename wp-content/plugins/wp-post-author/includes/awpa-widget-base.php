...
?>
        <p class="<?php echo esc_attr($active_callback); ?>">
            ...
            <input class="widefat <?php echo esc_attr($class) ?>" id="<?php echo esc_attr($this->get_field_id($field)); ?>" name="<?php echo esc_attr($this->get_field_name($field)); ?>" type="<?php echo esc_attr($type) ?>" value="<?php echo esc_attr($instance); ?>" />
            <?php if (!empty($note)) : ?>
