<?php 
    ...
    function blockspare_banner_nine_render_block($attributes){
        ...
        <div class='<?php  echo esc_attr($blockuniqueclass);?> align<?php echo esc_attr($alignclass) ?>'>
            <div class='<?php echo esc_attr( $animation_class ) ?> blockspare-banner-wrapper blockspare-banner-9-main-wrapper <?php echo esc_attr($attributes['bannerNineLayout']) ?> <?php echo esc_attr($attributes['blockHoverEffect']) ?>' blockspare-animation=<?php echo esc_attr( $attributes['animation'] )?>>
