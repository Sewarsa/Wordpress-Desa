<?php
     ...
     * Description:       Free Gutenberg Blocks for News, Magazine, and Business Websites (Templates, Patterns, and Page Builder)
     * Version:           2.6.5
     * Author:            Blockspare
    ...
    defined('ABSPATH') or die('No script kiddies please!');  // prevent direct access
                ...
                defined( 'BLOCKSPARE_VERSION' ) || define( 'BLOCKSPARE_VERSION', '2.6.4' );
