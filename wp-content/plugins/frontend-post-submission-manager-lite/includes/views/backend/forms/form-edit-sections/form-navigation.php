<div class="fpsml-shortcode-wrapper">
    ...
    <?php if ($form_row->form_type == 'login_require') { ?>
        <div class="fpsml-field-wrap fpsml-shortcode-common fpsml-pro-feature">
            <label>Dashboard Shortcode</label>
            <div class="fpsml-field">
                <span class="fpsml-shortcode-preview"><?php esc_html_e('Available in PRO Version', 'frontend-post-submission-manager-lite'); ?></span>
...
<div class="fpsml-form-nav-wrap">
    <ul class="fpsml-form-nav">
        ...
        <?php if ($form_row->form_type == 'login_require') { ?>
            ...
            <li class="fpsml-pro-feature"><a href="javascript:void(0);" class="fpsml-nav-item" data-tab="upgrade"><span class="dashicons dashicons-dashboard"></span><?php esc_html_e('Dashboard', 'frontend-post-submission-manager-lite'); ?></a></li>
        <?php } ?>
