...
if ( ! function_exists( 'museo_get_pages' ) ) :
/**
 ...
 */
function museo_get_pages() {

    $choices = array( 0 );

    // Default
    $choices = array( 'none' => esc_html__( 'None', 'museo' ) );
    ...
    return apply_filters( 'museo_get_pages', $choices );
}
endif;

if ( ! function_exists( 'museo_sanitize_pages' ) ) :
/**
 ...
 */
function museo_sanitize_pages( $value ) {
...
if ( ! function_exists( 'museo_get_categories' ) ) :
/**
...
function museo_get_categories() {
    ...
    return apply_filters( 'museo_get_categories', $choices );
}
endif;

if ( ! function_exists( 'museo_sanitize_categories' ) ) :
/**
 * Sanitize a value from a list of allowed values.
 *
 * @since 1.0.0.
 ...
 * @return mixed                The sanitized value.
 */
function museo_sanitize_categories( $value ) {

    $choices = museo_get_categories();
    $valid   = array_keys( $choices );
...
if ( ! function_exists( 'museo_get_tags' ) ) :
/**
...
function museo_get_tags() {
    ...
    return apply_filters( 'museo_get_tags', $choices );
}
endif;

if ( ! function_exists( 'museo_sanitize_tags' ) ) :
/**
 * Sanitize a value from a list of allowed values.
 *
 * @since 1.0.0.
 ...
 * @return mixed                The sanitized value.
 */
function museo_sanitize_tags( $value ) {

    $choices = museo_get_tags();
    $valid   = array_keys( $choices );
