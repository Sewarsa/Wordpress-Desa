...
class museo_notice_review extends museo_notice {
	...
	public function review_notice_markup() {
		...
		$dismiss_url = wp_nonce_url(
			remove_query_arg( array( 'activated' ), add_query_arg( 'museo-hide-notice', 'review-user-' . $this->current_user_id ) ),
		...
		if ( ( get_option( 'museo_theme_installed_time' ) > strtotime( '-21 day' ) ) ) {
			return;
		}
				...
				--><div class="academiathemes-message-text">
					...
					<p>
						...
						printf(
							...
							'<a href="' . esc_url( admin_url( 'themes.php?page=museo-doc' ) ) . '"><strong>' . esc_html( $theme_data->Name ) . ' Theme</strong></a>',
							'<br>',
					...
					<p class="notice-buttons"><a href="https://wordpress.org/support/theme/museo/reviews/#new-post" class="btn button button-primary academiathemes-button" target="_blank"><span class="dashicons dashicons-awards"></span> <?php esc_html_e( 'Add a Rating for Museo', 'museo' ); ?></a>
					<a href="<?php echo esc_url( $dismiss_url ); ?>" class="btn button button-secondary"><?php esc_html_e( 'Hide this notice', 'museo' ); ?></a>
					<a href="<?php echo esc_url( admin_url( 'themes.php?page=museo-doc' ) ); ?>" class="btn button button-secondary" target="_blank"><span><?php esc_html_e( 'Theme Help', 'museo' ); ?></span>
					</a></p>
